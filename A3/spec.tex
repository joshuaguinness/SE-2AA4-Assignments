...
I think that the two decks function is unecessary because if the creation of the deck is done properly, there is no need to check again if it was created properly. It seems redundant and not necessary.
